    ...
    <div className="testimonial">
      ...
      <div className="testimoniaInfo">
        <div className="testimonialR">
          ...
          <IoIosArrowBack className=' border-white w-8 h-8 border-radius-[50%] absolute cursor-pointer z-[999] text-white bg-transparent rounded-[50%] hover:bg-white hover:text-[gray]  arrow prev' onClick={nextSLide}/>
          <IoIosArrowForward className=' border-white w-8 h-8 border-radius-[50%] absolute cursor-pointer z-[999] text-white  bg-transparent rounded-[50%] hover:bg-white hover:text-[gray]     arrow next' onClick={prevSLide}/>
      ...
      <div className="mainSlide">
                 ...
                 
                  {
                    TestmonialData.map((testimo,index)=>{
                      return(
                        <div className={index === testimonial ? 'slideContent ease-[0.5s] slide current': "slide"} key={index} >
                        {index === testimonial && (
                          <>
