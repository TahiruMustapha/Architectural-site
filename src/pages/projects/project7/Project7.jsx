    ...
    <div className="planBg projectsbg">
      <div>
        ...
        <div className='ongoining'>
          <span >
            ...
            <MdOutlineKeyboardDoubleArrowRight /><Link to="/projects">Projects</Link><MdOutlineKeyboardDoubleArrowRight /> Ongoing <MdOutlineKeyboardDoubleArrowRight className='ml-[.5rem]'/> Project 7
          </span>
        </div>
      </div>
    </div> 
      <div className="projectsContent">
        ...
        <div className="client__says">
          ...
          className="mySwiper"
          >
           <SwiperSlide><img src={pro18} alt="img" /></SwiperSlide>
           <SwiperSlide><img src={pro17} alt="img" /></SwiperSlide>
          </Swiper>
          </div>
