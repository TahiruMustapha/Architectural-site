        ...
        <div>
          ...
          <div className='ongoining'>
            <span >
              ...
              <MdOutlineKeyboardDoubleArrowRight /><Link to="/projects">Projects</Link><MdOutlineKeyboardDoubleArrowRight /> Ongoing <MdOutlineKeyboardDoubleArrowRight className='ml-[.5rem]'/> Project 6
            </span>
          </div>
        </div>
      </div> 
