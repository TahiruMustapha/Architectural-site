      ...
      <div>
        ...
        <div className='ongoining'>
          <span >
            ...
            <MdOutlineKeyboardDoubleArrowRight /><Link to="/projects">Projects</Link><MdOutlineKeyboardDoubleArrowRight /> Ongoing <MdOutlineKeyboardDoubleArrowRight className='ml-[.5rem]' /> Project 5
          </span>
        </div>
      </div>
    </div> 
      <div className="projectsContent">
        ...
        <div className="client__says">
          ...
          >
            ...
            <SwiperSlide><img src={pro23} alt="img" /></SwiperSlide>
          </Swiper>
          </div>
