    ...
    <div className="planBg projectsbg">
      <div>
        ...
        <div className='ongoining'>
          <span >
            ...
            <MdOutlineKeyboardDoubleArrowRight /><Link to="/projects">Projects</Link><MdOutlineKeyboardDoubleArrowRight /> Ongoing <MdOutlineKeyboardDoubleArrowRight /> Project 2
          </span>
        </div>
      </div>
    </div> 
      <div className="projectsContent">
        ...
        <div className="client__says">
          ...
          className="mySwiper"
          >
            <SwiperSlide><img src={pro11} alt="img" /></SwiperSlide>
          </Swiper>
          </div>
